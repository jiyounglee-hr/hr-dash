...
st.sidebar.markdown('<a href="https://hr-resume-uzu5bngyefgcv5ykngnhcd.streamlit.app/~/+/?page=admin" target="_blank" class="sidebar-link" style="text-decoration: none;"> ㄴ 면접 평가서 관리</a>', unsafe_allow_html=True)
