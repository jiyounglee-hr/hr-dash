                ...
                if submitted:
                    try:
                        ...
                        - 제시금액 계산 로직
                            1. 최종보상 * 1.1 < 평균연봉인 경우
                               → 최종보상 * 1.1 (10% 증액)
                            2. 최종보상 * 1.05 < 평균연봉인 경우
                               → 평균연봉
                            3. 최종보상 * 1.05 >= 평균연봉인 경우
                               → 최종보상 * 1.05까지 제안 (5% 증액)
                            4. 최종보상 > 평균연봉 (단, 최종보상 <= 최대연봉)인 경우
                               → 최종보상 * 1.02까지 제안 (2% 증액) 
                            5. 최종보상 > 최대연봉인 경우
                               → 별도 계산 필요
                        """)
                        ...
                        with st.expander("📌 분석 기준 보기"):
                            ...
                            2. 제시금액 계산                 
                                - <strong>최종보상 * 1.1 < 평균연봉</strong>이면 최종보상 * 1.1 정도 제안 (10% 증액) 
                                - <strong>최종보상 * 1.05 < 평균연봉</strong>이면 평균연봉 정도 제안 (5% 증액) 
                                - <strong>최종보상 * 1.05 >= 평균연봉</strong>이면 최종보상 * 1.05까지 제안 (5% 증액) 
                                - <strong>최종보상 > 평균연봉 (단, 최종보상 <= 최대연봉)</strong>이면 최종보상 * 1.02까지 제안 (2% 증액) 
                                - <strong>최종보상 > 최대연봉</strong>이면 별도 계산 필요
                            """)
                    except Exception as e:
