...
st.sidebar.markdown('<a href="https://hr-resume-uzu5bngyefgcv5ykngnhcd.streamlit.app/~/+/?page=admin" target="_blank" class="sidebar-link" style="text-decoration: none;"> &nbspㄴ 면접 평가서 관리</a>', unsafe_allow_html=True)
st.sidebar.markdown('<a href="https://docs.google.com/spreadsheets/d/1zwYJ2hwneCeSgd6p4s9ngll8PDmhLhq9qOTRo5SLCz8/edit?gid=0#gid=0" target="_blank" class="sidebar-link" style="text-decoration: none;"> &nbsp ㄴ 면접 평가서 DB</a>', unsafe_allow_html=True)
st.sidebar.markdown('<a href="https://docs.google.com/spreadsheets/d/1SfVtvaHgXesDFtdFozt9CJD8aQpPBrK76AxNj-OOfFE/edit?gid=0#gid=0" target="_blank" class="sidebar-link" style="text-decoration: none;"> &nbspㄴ 평가기준 및 채용공고 DB</a>', unsafe_allow_html=True)
