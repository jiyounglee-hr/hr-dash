...
with st.sidebar.expander("🚀 채용전형관리"):
    st.markdown('<a href="https://hr-resume-uzu5bngyefgcv5ykngnhcd.streamlit.app/" target="_blank" class="sidebar-link" style="text-decoration: none; color: #1b1b1e;">▫️ 채용 전형 시스템</a>', unsafe_allow_html=True)
